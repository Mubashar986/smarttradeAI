    ...
    T: ToolExecutor,
{
    ...
    /// Run a turn without adding a new user message (it's already in the session).
    /// Auto-approves all permissions (headless server mode).
    pub fn run_turn_headless(&mut self) -> Result<TurnSummary, RuntimeError> {
